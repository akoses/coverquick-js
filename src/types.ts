...
export type ResumeOptions = HeaderProps | SummaryProps | EducationPropsArr | ExperiencePropsArr | ProjectPropsArr | SkillPropsArr | AwardPropsArr | CertificationPropsArr | AccomplishmentsProps |  PublicationPropsArr | ReferencePropsArr | VolunteerPropsArr;
