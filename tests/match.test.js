...
(0, node_test_1.describe)("Test Match functionality", () => {
    (0, node_test_1.it)("should match a resume", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let res3 = yield coverQuick.match(resume_id, classifier_id);
        node_assert_1.strict.notEqual(res3.Education, undefined);
        node_assert_1.strict.notEqual(res3['Years of Experience'], undefined);
    }));
});
